...
static std::string name_space = "ClientTst";

static Journal journal("ClientTests");
...
class ClientTestDouble : public ::testing::Test {
protected:

    ClientTestDouble() : rows(100),
                   cols(60),
                   iterations(1000000),
                   client_ptr(new Client<double>(rows, cols,
    ...
    int cols;
    int iterations;
    Server<double>::UniquePtr client_ptr;
    Tensor<double> tensor_copy;

};

class ClientTestFloat : public ::testing::Test {
protected:

    ClientTestFloat() : rows(100),
                   cols(60),
                   iterations(1000000),
                   client_ptr(new Client<float>(rows, cols,
...
class ClientTestInt : public ::testing::Test {
protected:
    ClientTestInt() : rows(100),
                   cols(60),
                   iterations(1000000),
                   client_ptr(new Client<int>(rows, cols,
...
class ClientTestBool : public ::testing::Test {
protected:
    ClientTestBool() : rows(100),
                   cols(60),
                   iterations(1000000),
                   client_ptr(new Client<bool>(rows, cols,
...
TEST_F(ClientTestBool, WriteReadBenchmark) {
    ...
    const MMap<bool>& tensorView = client_ptr->getTensorView(); // its a reference
    // we only need to get it once

    journal.log("ClientTestBool", "\nBenchmarking performance with bool type...\n",
                Journal::LogType::STAT);
...
TEST_F(ClientTestInt, WriteReadBenchmark) {
    ...
    const MMap<int>& tensorView = client_ptr->getTensorView(); // its a reference
    // we only need to get it once

    journal.log("ClientTestInt", "\nBenchmarking performance with int type...\n",
                Journal::LogType::STAT);
...
TEST_F(ClientTestFloat, WriteReadBenchmark) {
    ...
    const MMap<float>& tensorView = client_ptr->getTensorView(); // its a reference
    // we only need to get it once
...
TEST_F(ClientTestDouble, WriteReadBenchmark) {
    ...
    const MMap<double>& tensorView = client_ptr->getTensorView(); // its a reference
    // we only need to get it once

    journal.log("ClientTestDouble", "\nBenchmarking performance with double type...\n",
                Journal::LogType::STAT);
...
int main(int argc, char** argv) {
    ...
    // This example runs two test cases: ClientTestDouble.WriteReadBenchmark and AnotherTestSuite.*

    ::testing::GTEST_FLAG(filter) =
            "JournalTest.TestJournal";

    ::testing::GTEST_FLAG(filter) += ":ClientTestDouble.WriteReadBenchmark";
    ::testing::GTEST_FLAG(filter) += ":ClientTestFloat.WriteReadBenchmark";
    ::testing::GTEST_FLAG(filter) += ":ClientTestInt.WriteReadBenchmark";
    ::testing::GTEST_FLAG(filter) += ":ClientTestBool.WriteReadBenchmark";
